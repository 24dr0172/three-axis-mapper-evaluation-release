...
replay_dir="$(mktemp -d /tmp/three-axis-quick-XXXXXX)"
...
"$PYTHON_BIN" -B code/reproduction/regenerate_all.py \
  --output-dir "$replay_dir/regenerated" \
  --skip-axis1-recomputation --skip-construction-replay
...
echo "QUICK_RELEASE_CHECKS_PASSED"
